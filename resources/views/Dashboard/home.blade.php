    ...
    <div class="row">
                    ...
                    <div class="card-spacer mt-n25">
                        ...
                        <div class="row m-0">
                            <div class="col bg-light-warning px-6 py-8 rounded-xl mr-7 mb-7">
                                ...
                                <a href="{{route('invoices.index')}}" class="text-warning font-weight-bold font-size-h6">{{__('lang.invoices')}} : {{$data['invoices']}}</a>
                            </div>
                            <div class="col bg-light-primary px-6 py-8 rounded-xl mb-7">
                                ...
                                <a href="{{route('customers.index')}}" class="text-primary font-weight-bold font-size-h6 mt-2">{{trans('lang.customers')}} : {{$data['customers']}}</a>
                            </div>
                        </div>
                        <!--end::Row-->
                        <!--begin::Row-->
                        <div class="row m-0">
                            <div class="col bg-light-danger px-6 py-8 rounded-xl mr-7">
                                ...
                                <a href="#" class="text-danger font-weight-bold font-size-h6 mt-2">القائمة السوداء  {{$data['customers_blocked']}}</a>
                            </div>
                            <div class="col bg-light-success px-6 py-8 rounded-xl">
                                ...
                                <a href="#" class="text-success font-weight-bold font-size-h6 mt-2">طلبات التقسيط {{$data['installment_requests']}}</a>
                            </div>
                        </div>
                        <!--end::Row-->
                    </div>
            ...
            <div class="card card-custom card-stretch gutter-b">
                ...
                <div class="card-header align-items-center border-0 mt-4">
                    <h3 class="card-title align-items-start flex-column">
                        ...
                        <span class="text-muted mt-3 font-weight-bold font-size-sm">{{\Carbon\Carbon::now()->format('Y-m-d')}}</span>
                    </h3>
                ...
                <div class="card-body pt-4">
                    ...
                    <div class="timeline timeline-6 mt-3">
                        ...
                        <div class="timeline-item align-items-start">
                            <!--begin::Label-->
                            <div class="timeline-label font-weight-bolder text-dark-75 font-size-lg">{{$row->created_at->format('H:i')}}</div>
                            <!--end::Label-->
                            <!--begin::Badge-->
                            ...
                            <!--end::Badge-->
                            <!--begin::Text-->
                            <div class="timeline-content font-weight-bolder text-dark-75 pl-3 font-size-lg">{{$row->description}}
        ...
        <div class="col-lg-6 col-xxl-4 order-1 order-xxl-1">
            ...
            <div class="card card-custom card-stretch gutter-b">
                ...
                <div class="card-header border-0 pt-5">
                    <h3 class="card-title align-items-start flex-column">
                        <span class="card-label font-weight-bolder text-dark">الاقساط المتأخره</span>
        ...
        <div class="col-xxl-8 order-2 order-xxl-1">
            ...
            <div class="card card-custom card-stretch gutter-b">
                ...
                <div class="card-header border-0 pt-5">
                    <h3 class="card-title align-items-start flex-column">
                        <span class="card-label font-weight-bolder text-dark">اقساط اليوم الحالي</span>
