...
class CustomerCreateRequest extends FormRequest
{
   ...
   public function rules()
   {
       $validation = [
           ...
           'id_image_back'=>['nullable','image','mimes:jpeg,png,jpg',Rule::requiredIf(function() {  return Request::routeIs('customers.create');})],
           'id_image_front'=>['nullable','image','mimes:jpeg,png,jpg',Rule::requiredIf(function() {  return Request::routeIs('customers.create');})],
